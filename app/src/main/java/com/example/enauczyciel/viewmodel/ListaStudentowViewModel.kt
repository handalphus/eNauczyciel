...
class ListaStudentowViewModel(application: Application):AndroidViewModel(application) {
...
//    }
    ...
    suspend fun dodajStudenta(imie: String, nazwisko: String) {
        studentRepository.add(imie, nazwisko)
